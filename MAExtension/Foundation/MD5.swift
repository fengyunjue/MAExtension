...
extension HashProtocol {
    ...
    public func prepare(_ len: Int) -> Array<UInt8> {
...
public struct BytesIterator: IteratorProtocol {
    ...
    public mutating func next() -> ArraySlice<UInt8>? {
...
public func rotateLeft(_ value: UInt32, bits: UInt32) -> UInt32 {
    return ((value << bits) & 0xFFFFFFFF) | (value >> (32 - bits))
}

public class MD5: HashProtocol {
    
    public static let size = 16 // 128 / 8
